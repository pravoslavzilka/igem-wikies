...
const PARTNERS_DATA = {
  ...
  enablementPartners: [
    ...
    },
    {
      company: {
        name: "Diana Bio",
        logo: "https://static.igem.wiki/teams/5642/images/homepage/footer/diana-logo-blue-color.webp",
        alt: "Diana Bio Logo",
        url: "https://www.dianabiotech.com/",
        category: "Enablement Partner"
      }
    },
    {
      company: {
        name: "MUltiplexDX",
        logo: "https://static.igem.wiki/teams/5642/images/homepage/footer/enablement-p-multiplexdx.webp",
        alt: "MUltiplexDX Logo",
        url: "https://www.multiplexdx.com/",
        category: "Enablement Partner"
      }
    }
  ],
  specialPartners: [
    {
      company: {
        name: "Farma Pecinov",
        logo: "https://static.igem.wiki/teams/5642/images/homepage/footer/farma-pecinov.webp",
        alt: "Farma Pecinov Logo",
        url: "https://pecinov.com/?gad_source=1&gad_campaignid=22874195463&gbraid=0AAAAADnk0B0o6cEz_pdyvjW7GTIgUwgVA&gclid=CjwKCAjwlt7GBhAvEiwAKal0cvCDvPAu3l4r3242_rC85Vgb8ksnOMGbH-N7r2qQfYaJaDuu75JtkRoCN-cQAvD_BwE",
    ...
    },
    {
      company: {
        name: "Vican Winery",
        logo: "https://static.igem.wiki/teams/5642/images/homepage/footer/vican-winery.webp",
        alt: "Vican Winery Logo",
        url: "https://www.vican.wine/",
        category: "Special Partner"
      }
    },
    {
      company: {
        name: "Fifty Beans",
        logo: "https://static.igem.wiki/teams/5642/images/homepage/footer/fiftybeans.webp",
        alt: "Fifty Beans Logo",
        url: "https://fiftybeans.cz/cs/?gad_source=1&gad_campaignid=12703515521&gbraid=0AAAAADQnmQUinVH4RRFWtr037E-MJ2Qcc&gclid=CjwKCAjw89jGBhB0EiwA2o1On21iNcNyQtMz007xjmSYrix2WiUXBwzIJMMa3ojvXXCRN5aDAxAePRoCymIQAvD_BwE",
        category: "Special Partner"
      }
    }
  ]
...
const LogoCard: React.FC<LogoCardProps> = ({ company, label, isStrategic }) => {
  const renderLabel = () => {
    ...
    return (
      <div
        className="text-center whitespace-pre-line mb-1 sm:mb-1"
...
const PartnersSection: React.FC<PartnersSectionProps> = ({ title, partners, isStrategic }) => {
  const isSpecialPartners = title === "Special Partners";
  
  return (
    <div className={`space-y-1 sm:space-y-2 lg:space-y-2 ${CONFIG.partnerCard.sectionWidth} mx-auto`}>
      {title && (
        <h3
      ...
      <div className={`${isSpecialPartners ? 'flex flex-wrap justify-center gap-4 sm:gap-6 lg:gap-8' : `grid ${isStrategic ? CONFIG.partnerCard.strategicGridCols : CONFIG.partnerCard.gridCols} ${CONFIG.partnerCard.gridGap}`} px-2 sm:px-4`}>
...
const CopyrightSection: React.FC = () => (
  <div className={`pt-6 sm:pt-8 border-t ${CONFIG.colors.border} space-y-1 sm:space-y-2`}>
    <div className="flex flex-col items-center space-y-1 sm:space-y-2">
      ...
      <div className="space-y-1 text-center max-w-4xl px-4">
        <div
      ...
      <div className={`${CONFIG.layout.containerMaxWidth} mx-auto ${CONFIG.layout.partnerContainerPadding}`}>
        <div className="space-y-1 sm:space-y-2">
          ...
          <PartnersSection
            ...
            partners={PARTNERS_DATA.specialPartners}
          />
          <CopyrightSection />
        </div>
      </div>
