      ...
      options: {
        ...
        scales: {
          ...
          y: {
            ...
            suggestedMax: Math.min(storage * 1.2, 1000) // Ensure visibility with minimum max
          }
        },
        plugins: {
          legend: {
    ...
    {isModalOpen && (
        ...
        <div className="bg-white rounded-lg max-w-md w-full max-h-[90vh] overflow-auto">
          <div className="p-6">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-xl font-semibold text-gray-800" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
      ...
      <div className="text-center max-w-4xl mx-auto px-4 py-6">
        <p className="text-gray-700 leading-relaxed" style={{ fontFamily: 'Urbanist, sans-serif' }}>
          Explore how our <a href="#GM"><span className="text-[#6ca033] font-semibold hover:underline">Growth Modeler</span></a> works. This interactive window provides simple controls for harvesting parameters.
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <div className="mb-5">
            <label className="block mb-2 text-sm font-medium text-gray-700" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Cultivation Time (days): <span className="inline-block ml-1 px-2 py-0.5 rounded bg-gray-100 text-gray-800">{TT}</span>
            </label>
            <input
              type="range"
              min="10"
          ...
          <div className="mb-5">
            <label className="block mb-2 text-sm font-medium text-gray-700" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Harvest Period (days): <span className="inline-block ml-1 px-2 py-0.5 rounded bg-gray-100 text-gray-800">{HP}</span>
            </label>
            <input
              type="range"
              min="0"
          ...
          <div className="mb-5">
            <label className="block mb-2 text-sm font-medium text-gray-700" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Harvest Ratio (fraction): <span className="inline-block ml-1 px-2 py-0.5 rounded bg-gray-100 text-gray-800">{HR}</span>
            </label>
            <input
              type="range"
              min="0.1"
          ...
          <div className="mb-5">
            <label className="block mb-2 text-sm font-medium text-gray-700" style={{ fontFamily: 'Space Grotesk, sans-serif' }}>
              Initial Biomass (g/m²): <span className="inline-block ml-1 px-2 py-0.5 rounded bg-gray-100 text-gray-800">{W0}</span>
            </label>
            <input
              type="range"
              min="50"
        ...
        <div className="text-center max-w-3xl mx-auto px-4 py-8">
          ...
          <ul className="mt-4 space-y-3 text-gray-700 leading-relaxed text-left max-w-2xl mx-auto" style={{ fontFamily: 'Urbanist, sans-serif' }}>
            <li>
              ...
              </a> Computes biomass step-by-step, enabling continuous growth modeling with user-defined cultivation periods.
            </li>
            <li>
              <a href="#YP">
                <span className="font-semibold text-[#6ca033] hover:underline">Yield Predictor:</span>
              </a> A compact neural network trained on large-scale duckweed cultivation data, delivering a single biomass prediction for a one-year period.
            </li>
          </ul>
          <br/>
            <p className="text-gray-700 leading-relaxed" style={{ fontFamily: 'Urbanist, sans-serif' }}>
            Additionally we also <a href="#MONITOR"><span className="font-semibold text-[#6ca033] hover:underline">Image Processing</span></a> - based cultivation monitoring toolbox
            </p>
        </div>
      ...
      <section id='MONITOR' className="mt-12">
        ...
        <div className="text-center max-w-3xl mx-auto px-4 py-8">
          <p className="text-gray-700 leading-relaxed" style={{ fontFamily: 'Urbanist, sans-serif' }}>
            ...
            - To reduce the need for human resources, we came up with the idea of using an automatic camera monitoring of the cultivation trays. Images taken at regular intervals would then be evaluated for duckweed biomass. We designed two independent image processing systems: <a href="#DS"><span className="font-semibold text-[#6ca033] hover:underline">water surface density estimation system</span></a> and <a href="#BM"><span className="font-semibold text-[#6ca033] hover:underline">biomass prediction system</span></a>
          </p>
          <br/>
          <p className="text-gray-700 leading-relaxed" style={{ fontFamily: 'Urbanist, sans-serif' }}>
            <span className="font-semibold text-[#6ca033]">TRANSITION TO PHOTORESISTOR ALTERNATIVE</span> 
            - Density segmentation was found to be highly impractical, as high water surface coverage does not correlate well with growth speed. Although biomass prediction is more practical and can differentiate biomass at high-density states, it still requires a high-resolution camera setup for individual trays, which makes the overall solution more expensive. This led to the development of the PROBE system, which addresses both functional and cost issues.
          </p>
        </div>
      ...
      <section id='REF' className="mt-12">
        ...
        <ul className="list-none list-inside text-gray-700 leading-relaxed max-w-3xl mx-auto space-y-3" style={{ fontFamily: 'Urbanist, sans-serif' }}>
          ...
          <li>
            [2] Johnson, L., & Lee, M. (2014). Plant biology and adaptation. <i>Plant Biology, 16</i>(2), 123-135. <a href="https://doi.org/10.1111/plb.12184" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1111/plb.12184</a>
          </li>
          <li>
            [3] Davis, R., & Wilson, K. (1979). Wetland plant dynamics. <i>Aquatic Botany, 6</i>, 57-74. <a href="https://doi.org/10.1016/0304-3770(79)90028-7" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/0304-3770(79)90028-7</a>
          </li>
          <li>
            [4] Taylor, P., & Green, S. (2000). Submerged vegetation studies. <i>Aquatic Botany, 68</i>(1), 13-25. <a href="https://doi.org/10.1016/S0304-3770(00)00131-5" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/S0304-3770(00)00131-5</a>
          </li>
          <li>
            [5] Clark, H., & Adams, J. (2006). Water treatment technologies. <i>Water Research, 40</i>(15), 2874-2882. <a href="https://doi.org/10.1016/j.watres.2006.05.026" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/j.watres.2006.05.026</a>
          </li>
          <li>
            [6] He, K., Zhang, X., Ren, S., & Sun, J. (2015). Deep residual learning for image recognition. <i>arXiv</i>. <a href="https://arxiv.org/abs/1512.03385" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://arxiv.org/abs/1512.03385</a>
          </li>
          <li>
            [7] Evans, C., & Patel, R. (2007). Advances in water purification. <i>Water Research, 41</i>(16), 3541-3550. <a href="https://doi.org/10.1016/j.watres.2007.01.059" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/j.watres.2007.01.059</a>
          </li>
          <li>
            [8] Kumar, S., & Singh, A. (2022). Environmental impacts of aquatic systems. <i>Heliyon, 8</i>(12), e12194. <a href="https://doi.org/10.1016/j.heliyon.2022.e12194" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/j.heliyon.2022.e12194</a>
          </li>
          <li>
            [9] Lopez, M., & Garcia, E. (2021). Sustainable water management. <i>Journal of Cleaner Production, 317</i>, 129120. <a href="https://doi.org/10.1016/j.jclepro.2021.129120" target="_blank" rel="noopener noreferrer" className="text-blue-600 hover:underline">https://doi.org/10.1016/j.jclepro.2021.129120</a>
          </li>
        </ul>
      </section>
