...
const SustainabilityDocument = () => {
  return (
    <div className="max-w-6xl mx-auto p-8 bg-white font-sans" style={{ fontFamily: "Space Grotesk, sans-serif" }}>
      {/* Header */}
      ...
      {/* SDG 2: Zero Hunger */}
      <div className="mb-6 bg-white border border-gray-200 rounded-lg shadow-sm border-l-4 border-l-green-500">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-green-50 text-green-700 border border-green-300 rounded-md text-sm font-medium">
              SDG 2
            </span>
            <h2 className="text-xl font-bold text-gray-900">Zero Hunger</h2>
          </div>
          <p className="text-justify leading-relaxed text-gray-800 mb-4">
      ...
      <div className="mb-6 bg-white border border-gray-200 rounded-lg shadow-sm border-l-4 border-l-blue-500">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-blue-50 text-blue-700 border border-blue-300 rounded-md text-sm font-medium">
              SDG 6
            </span>
            <h2 className="text-xl font-bold text-gray-900">Clean Water and Sanitation</h2>
          </div>
          <p className="text-justify leading-relaxed text-gray-800 mb-4">
      ...
      <div className="mb-6 bg-white border border-gray-200 rounded-lg shadow-sm border-l-4 border-l-orange-500">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-orange-50 text-orange-700 border border-orange-300 rounded-md text-sm font-medium">
              SDG 9
            </span>
            <h2 className="text-xl font-bold text-gray-900">Industry, Innovation, and Infrastructure</h2>
          </div>
          <p className="text-justify leading-relaxed text-gray-800">
      ...
      <div className="mb-6 bg-white border border-gray-200 rounded-lg shadow-sm border-l-4 border-l-purple-500">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-purple-50 text-purple-700 border border-purple-300 rounded-md text-sm font-medium">
              SDG 12
            </span>
            <h2 className="text-xl font-bold text-gray-900">Responsible Consumption and Production</h2>
          </div>
          <p className="text-justify leading-relaxed text-gray-800 mb-4">
      ...
      <div className="mb-8 bg-white border border-gray-200 rounded-lg shadow-sm border-l-4 border-l-red-500">
        <div className="p-6">
          <div className="flex items-center gap-3 mb-4">
            <span className="px-3 py-1 bg-red-50 text-red-700 border border-red-300 rounded-md text-sm font-medium">
              SDG 13
            </span>
            <h2 className="text-xl font-bold text-gray-900">Climate Action</h2>
          </div>
          <p className="text-justify leading-relaxed text-gray-800 mb-4">
