...
interface ExpandablePillNoImageProps {
    name: string;
    subtitle?: string;
    location?: string;
...
const ExpandablePillNoImage: React.FC<ExpandablePillNoImageProps> = ({
                                                                         name,
                                                                         subtitle,
                                                                         location,
                                                                         children,
    ...
    return (
        ...
        ${expanded || closing ? "rounded-t-[72px] rounded-b-none" : "rounded-[72px]"}`}
            >
                ...
                <div className="flex-1 text-center px-8 py-6">
                    <p
...
export default ExpandablePillNoImage;
