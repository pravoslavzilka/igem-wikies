        ...
        },
        {
            ...
            members: [
...

                {
                    ...
                    description: "In the chaotic world around her, Miška strives to understand everything - from science to the everyday moments of life. Amid the hustle and bustle, she finds peace in nature, calisthenics, and meditation. Through iGEM, she became involved in many scientific activities and plans to continue exploring this path. Wherever life leads next, she’s eager to see what unfolds.",
                ...
                },
                {
                    ...
                    description: "There has always been something fascinating about living nature — a curiosity that drew him, even as a child, to sit and observe the world around him. That same fascination has endured, and since beginning his biology studies, he has continued to explore it with the same sense of wonder. Matěj loves spending time in nature, especially during summer scout camps, and often gets lost in deep thought. He also enjoys the musicality of people, even if he doesn’t consider himself a musician. In the summer, you’ll most likely spot him on his bicycle.",
        ...
        <div className="min-h-screen bg-amber-50">
            ...
            >
                ...
                <div className="flex-1 p-4 justify-center items-center p-8">
                    <div className="bg-white p-8 rounded-lg shadow-lg max-w-lg border-4 border-gray-800">
                        ...
                        <div className="text-sm text-justify space-y-4" style={{fontFamily: 'Urbanist, sans-serif'}}>
                            <p>
                                We're iGEM Brno — proudly the Duckweed Mafia. Our big, organized crew
                                splits into three main groups — the <strong>3H: Hackers, Hipsters and
                                Hustlers. </strong>
                            ...
                            <div>
                                <p className="font-bold text-black mb-1">
                                    <button
                                        ...
                                        className="hover:underline text-[#6ca033] transition-colors cursor-pointer"
                                    >
                                        Hackers
                                    </button>
                                </p>
                                <p className="mb-3">
                                    The builders and experimenters. Hackers run the bench, write code, test protocols
                                    and translate chaos into data. They split projects into clear tasks, document
                                    results and make sure every late night in the lab moves us closer to the goal.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mb-3">
                                    In our version of the 3H, hustlers are the cultivation crew. They design and manage
                                    systems: containers, cultivation conditions, optimal conditions for growth. They
                                    think about applications in the field, and set up routines for pumping & harvesting
                                    so our biology works reliably outside the lab.
                                </p>
                            </div>
                            ...
                            <div>
                                ...
                                <p className="mb-3">
                                    The storytellers and designers. They craft our identity, visuals and narrative so
                                    the science feels human and exciting. From brand to video, they make sure people get
                            ...
                            <div>
                                ...
                                <p className="mb-3">
                                    The glue across all teams. Founders coordinate, connect dots and keep the whole
                                    machine aligned. They care about long-term vision, hustle on lab experiments, design
                                    sessions and pitches — making sure all the moving parts work together.
                                </p>
                            </div>
            ...
            <div className="flex">
                ...
                >
                    ...
                    {/* Description */}
                    <div className="text-sm text-gray-700 mb-4 flex-shrink-0"
                         style={{fontFamily: 'Urbanist, sans-serif'}}>
                        <p className="mb-4">
                            <strong>Who is Duckweed Mafia?</strong>
                        </p>
                        <p className="mb-4">
                            We're iGEM Brno — proudly the Duckweed Mafia. Our big, organized crew splits into three main
                            groups — the 3H: Hackers, Hipsters and Hustlers. And of course, Founders stand behind it
                            all, helping connect and coordinate every piece of the puzzle.
                        </p>
                    </div>
                </div>
                            ...
                            >
                                ...
                                <div className="flex-1">
                                    ...
                                    <p className="text-md text-gray-500 mb-4 uppercase tracking-wide"
                                       style={{fontFamily: 'Urbanist, sans-serif'}}>
                                        QUEST: <b>{member.role}</b>
                                    </p>

                                    {/* Member Image */}
                                    <div className="mb-6">
                                        <div
                                            className="w-full h-64 bg-gray-200 rounded-lg flex items-center justify-center relative"
                                            ...
                                            {/* Name overlay */}
                                            <div
                                                className="absolute bottom-[-50px] right-4 bg-black bg-opacity-70 text-white px-3 py-1 rounded text-lg">
                                                {member.name}
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="text-lg text-gray-700"
                                         style={{fontFamily: 'Urbanist, sans-serif', paddingTop: '4rem'}}>
