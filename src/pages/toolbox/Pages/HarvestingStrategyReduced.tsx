        ...
        <div className="max-w-6xl mx-auto p-6 bg-white text-lg text-justify"
            ...
            <div className="mb-8">
                ...
                <div className="bg-gray-100 rounded-lg p-8 mb-4">
                    <img src="https://static.igem.wiki/teams/5642/images/how/predictor/graf-final-6.webp"
                         alt="Graph showing comparison between L. minor and L. japonica biomass yields"
                ...
                <div className="grid md:grid-cols-2 gap-8 mb-8">
                    ...
                    <div>
                        <p className="text-gray-700 leading-relaxed mb-4" style={{fontFamily: 'Urbanist, sans-serif'}}>
                            ...
                            40% and 50%. Each experiment was done in triplicates to ensure statistical significance and
                            the data reported below are the mean values.
                        </p>
                ...
                <div className="bg-gray-100 rounded-lg p-8 mb-4 mt-12">
                    <img src="https://static.igem.wiki/teams/5642/images/how/predictor/graf-final-7.webp"
                         alt="Graph showing comparison between L. minor and L. japonica biomass yields"
                         className="w-full h-auto"/>
              ...
              strategy experiments, where tested harvesting strategies were hf = 3 days
                ...
                <div className="bg-gray-100 mt-10 rounded-lg p-6 border-l-4 border-green-500">
                    <p className="text-gray-800 font-medium text-center" style={{fontFamily: 'Urbanist, sans-serif'}}>
                        After three iterations, we determined the best harvesting strategy to be hf = 3 and hr = 40%
                        with an
