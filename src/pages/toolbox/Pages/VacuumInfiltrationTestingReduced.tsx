...
export default function VacuumInfiltrationTestingReduced() {
    return (
        <div
            className="max-w-6xl mx-auto p-8 bg-white font-['Urbanist'] text-lg text-gray-800 leading-relaxed text-justify">
            {/* Header */}
            ...
            <div className="mb-8">
                <p className="mb-4">
                    ...
                    clones. Because we
                    suspected that each duckweed clone might respond differently, we systematically tested a range of
                    parameters in
                    parallel and aimed to simplify the protocol wherever possible. For these assays, we used
                    the <strong>pAMO052
                    construct</strong>, carrying the <strong>RUBY reporter</strong> under the <strong>rZmUBI
                    promoter</strong>, kindly provided by the Ordoñez Lab. The RUBY
                    reporter reconstitutes the <strong>betalain pathway</strong> from red beet, producing a visible red
                    pigment in plant tissues. This
            ...
            <section className="mb-8 mt-10">
                ...
                <p className="mb-4">
                    <em>Agrobacterium tumefaciens</em> strains differ in virulence and host range - testing several of
                    them (<strong>AtEHA105</strong>,
                    <strong>AtGV3101</strong> and <strong>AtC58C1</strong>) lets us find the most effective for our
                    species.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    We tested <strong>time of vacuum infiltration</strong> for <strong>5, 10, 15, and 20
                    minutes</strong> as longer vacuum application can pull bacteria
                    deeper into tissues but also risks tissue damage – we tested a range to find the optimum for each
                    clone.
                </p>
                <p className="mb-4">
                    We tested <strong>co-cultivation</strong> of <em>Agrobacterium</em> with duckweed under <strong>light
                    and dark conditions</strong> at <strong>21 °C</strong>, with the light on a
                    <strong> 16/8 h photoperiod</strong> at <strong>200 µmol photons·m⁻²·s⁻¹</strong>. Light can trigger
                    plant defenses, while darkness may favour T-
                    DNA transfer, so both conditions were compared.
                </p>
                <p className="mb-4">
                    As <strong>Silwet L-77</strong> is used in the protocol of Dr. Ordoñez as a surfactant to reduce
                    surface tension and improve
                    bacterial entry (typically in waxy leaves), we tested whether it boosts transformation efficiency in
                    our clones. Since we
                    found it difficult to obtain for some iGEM teams, showing that it is not strictly necessary would be
                    beneficial.
                </p>
            </section>
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    From the tested strains mentioned above, <strong>AtEHA105</strong> proved to be the most effective
                    for duckweed transformation,
                    followed by <strong>AtGV3101</strong> and <strong>AtC58C1</strong>. There was no difference in the
                ...
                <p className="mb-4">
                    <strong>Infiltration was most effective with 5 - 10 minutes</strong> of vacuum application. Longer
                    treatments (15 - 20 minutes)
                    caused excessive tissue damage and frond die-off.
                </p>
                <p className="mb-4">
                    <strong>Co-cultivation under light conditions</strong> resulted in healthier, faster-dividing
                    fronds, whereas co-cultivation in
                    <strong> darkness</strong> not only slowed growth but also prevented any transient expression.
                </p>
                <p className="mb-4">
                    The addition of <strong>Silwet L-77</strong> had no effect compared to the control, probably because
                    duckweed leaves are not as
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
                    ...
                    <img src="https://static.igem.wiki/teams/5642/images/toolbox/vacumtesting/vacuum-pics-min.webp"
                         alt="Lemna gibba 7742 expressing RUBY after 5 min vacuum and light co-cultivation"
            ...
            <section className="mb-8">
                ...
                <p className="mb-4">
                    We demonstrated (although unintentionally) that the longer you reuse the
                    same <em>Agrobacterium</em> culture for inoculation
                    of new culture for transformation, the less efficient the transformation becomes. We found this
                    through repeated
                    deliveries of <strong>pAMO101 constructs</strong> (GFP reporter driven by rZmUBI promoter), which
                    served as a reliable control for
                    our TAIFR assays. Since we knew this construct was functional, it acted as a gold standard for
                    testing whether our
                    vacuum infiltration was efficient, independent of the construct being evaluated. For a long time, we
                    could not identify
                ...
                <p className="mb-4">
                    ...
                    an <em>Agrobacterium</em> colony identified as
                    positive (by colony PCR) and functionally verified by transformation. New transformations
                    should <strong>always be started
                    from glycerol stock</strong>, not from leftover culture used in previous transformations and stored
                    in the fridge, as we had
                    done.
                </p>
            </section>
            ...
            <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-7 gap-4">
                    ...
                    <img src="https://static.igem.wiki/teams/5642/images/toolbox/vacumtesting/vacuum-pics-miniv.webp"
                         alt="Lemna gibba 7742 expressing RUBY after 5 min vacuum and light co-cultivation"
                         className=" object-cover col-span-5 md:h-64"/>
